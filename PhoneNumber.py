...
class PhoneNumber:
    ...
    def set_exchange(self, exchange_number):
        if len(exchange_number) == 3:
            ...
            raise InvalidPhoneNumber(
                f"The exchange number is not the correct length "
                f"to get valid phone number."
            )
    ...
    def set_subscriber_number(self, subscriber_number):
        if len(subscriber_number) == 4:
            ...
            raise InvalidPhoneNumber(
                f"The subscriber number is not the correct length "
                f"to get valid phone number."
            )
    ...
    def is_valid(number_to_check):
        ...
        # that are not part of a valid number
